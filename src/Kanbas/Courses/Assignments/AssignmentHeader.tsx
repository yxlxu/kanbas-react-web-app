...
export default function AssignmentHeader({ courseId }: { 
  ...
  return (
    <div className="d-inline float-end d-inline-flex">
      ...
      </div> {isFaculty && <button id="wd-add-assignment-group" className="btn btn-lg btn-secondary me-1">
          + Group
      </button>} {isFaculty && <button id="wd-add-assignment" className="btn btn-lg btn-danger"
          type="button"
